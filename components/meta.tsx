...
const CustomMeta = (MetaProps: Meta) => {
  return (
    <Head>
      ...
      <meta
        name="description"
        content={MetaProps.description || DefaultProps.description}
      />
      <link
        rel="icon"
        type="image/png"
        href={MetaProps.favicon || DefaultProps.favicon}
      />
      ...
      <meta
        property="og:title"
        content={MetaProps.title || DefaultProps.title}
      />
      <meta
      ...
      <meta
        property="og:image"
        content={MetaProps.image || DefaultProps.image}
      />
      {/* TWITTER */}
      <meta
        property="twitter:card"
        content={MetaProps.twitter?.card || DefaultProps.twitter?.card}
      />
      <meta
        property="twitter:url"
        content={MetaProps.url || DefaultProps.url}
      />
      <meta
      ...
      <meta
        ...
        content={MetaProps.twitter?.site || DefaultProps.twitter?.site}
      />
    </Head>
  );
};
